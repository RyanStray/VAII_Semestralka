                            ...
                            {companies.map((companies) => (
                                <TableRow >
                                    ...
                                    <TableCell className='space-x-1'>
                                        <Link href = {route('company.edit', companies.id)}><Button className='nav-button'>Edit</Button></Link>
                                    </TableCell>
                                    <TableCell><Button disabled={processing} onClick={() => handleDelete(companies.id, companies.name)} className='delete-button'>Delete</Button></TableCell>
                                </TableRow >
                            ))}
